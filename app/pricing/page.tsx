...
export default function PricingPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      ctaLabel: currentTier === "pro" ? "Current Plan" : "Premium ₵500 /mo",
      ctaVariant: "primary" as const,
      annualNote: "₵5000 a year (save 10%)",
    },
    {
      ...
      ctaLabel: currentTier === "business" ? "Current Plan" : "Business ₵1000 /mo",
      ctaVariant: "primary" as const,
      annualNote: "₵10000 a year (save 10%)",
    },
  ];
